...
describe('LinkFinder', function() {
  it('should return empty array when response does not contain any links', function() {
    const responseBody = {
      a:1,
      b:"hello world",
      c: [1,2,3]
  ...
  it('should return links that are in the root of the body', function() {
    const responseBody = {
      a:1,
      b:"hello world",
      c: [1,2,3],
  ...
  it('should return links that are in an array', function() {
    const responseBody = {
      a:1,
      b:"hello world",
      c: [
  ...
  return it('should return links recursively', function() {
    const responseBody = {
      a:1,
      b:"hello world",
      c: [
